...
public class MerchantPayment extends RouteBuilder {
    ...
    @Autowired
    public MerchantPayment (CamelContext camelContext, HubSettings hubSettings, GSMASettings ottSettings) {
    ...
    public void configure() throws Exception {
        ...
        BindingProperties binding = ottSettings.getBinding(GSMASettings.OttBinding.MERCHANTPAYMENT);
