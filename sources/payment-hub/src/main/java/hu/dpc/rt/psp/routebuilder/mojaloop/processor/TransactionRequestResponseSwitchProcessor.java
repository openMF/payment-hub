...
/**
 * Processor to send PUT /transactionRequests response through the switch.
 */
@Component("transactionRequestResponseSwitchProcessor")
public class TransactionRequestResponseSwitchProcessor implements Processor {
    ...
    @Autowired
    public TransactionRequestResponseSwitchProcessor(TransactionContextHolder transactionContextHolder, SwitchRestClient switchRestClient) {
