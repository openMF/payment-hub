...
public class IlpBuilderDpc {
    ...
    public Ilp build(String transactionId, String quoteId, BigDecimal transactionAmount, String currency, hu.dpc.rt.psp.dto.Party payer,
                     hu.dpc.rt.psp.dto.Party payee, BigDecimal transferAmount) throws IOException {
    ...
    private Transaction mapToTransaction(String transactionId, String quoteId, BigDecimal transactionAmount, String currency,
                                         hu.dpc.rt.psp.dto.Party payer, hu.dpc.rt.psp.dto.Party payee) {
    ...
    private Transaction mapToTransaction(String transactionId, String quoteId, Money transactionAmount, hu.dpc.rt.psp.dto.Party payer, hu.dpc.rt.psp.dto.Party payee) {
